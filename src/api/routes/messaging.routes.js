...
import contactGroupController from "../controllers/messaging/contact-group.controller.js";
...
route.post(
  "/contacts/sync-whatsapp",
  asyncHandler(contactController.syncWhatsApp),
);
route.get(
  "/contacts/:id",
  validateObjectId("id"),
  asyncHandler(contactController.getOne),
);
route.post(
  "/contacts",
  validateContact,
...
route.post(
  "/contacts/:id/block",
  validateObjectId("id"),
  asyncHandler(contactController.block),
);
route.post(
  "/contacts/:id/unblock",
  validateObjectId("id"),
  asyncHandler(contactController.unblock),
);
route.post(
  "/contacts/:id/opt-out",
  validateObjectId("id"),
  asyncHandler(contactController.optOut),
);
route.post(
  "/contacts/:id/tags",
  validateObjectId("id"),
  asyncHandler(contactController.setTags),
);
route.get(
  "/contacts/:id/activities",
  validateObjectId("id"),
  asyncHandler(contactController.getActivities),
);
...
route.post(
  ...
  asyncHandler(contactGroupController.create),
);
route.get(
  "/contact-groups/:id",
  validateObjectId("id"),
  asyncHandler(contactGroupController.getOne),
);
route.patch(
  "/contact-groups/:id",
  validateObjectId("id"),
  validateContactGroup,
  asyncHandler(contactGroupController.update),
);
route.delete(
  "/contact-groups/:id",
  validateObjectId("id"),
  asyncHandler(contactGroupController.remove),
);
route.post(
  "/contact-groups/:id/contacts",
  validateObjectId("id"),
  asyncHandler(contactGroupController.addContacts),
);
route.delete(
...
route.get(
  "/templates/:id",
  validateObjectId("id"),
  asyncHandler(templateController.getOne),
);
route.patch(
  "/templates/:id",
  validateObjectId("id"),
...
route.post(
  ...
  validateObjectId("id"),
  asyncHandler(templateController.preview),
);
...
route.get(
  "/campaigns/:id",
  validateObjectId("id"),
  asyncHandler(campaignController.getOne),
);
route.patch(
  "/campaigns/:id",
  validateObjectId("id"),
...
route.post(
  ...
  validateObjectId("id"),
  asyncHandler(campaignController.preview),
);
route.get(
  "/campaigns/:id/audience",
  validateObjectId("id"),
  asyncHandler(campaignController.audience),
);
route.get(
  "/campaigns/:id/recipients",
  validateObjectId("id"),
  asyncHandler(campaignController.recipients),
);
route.get(
  "/campaigns/:id/stats",
  validateObjectId("id"),
  asyncHandler(campaignController.stats),
);
route.post(
  "/campaigns/:id/start",
  validateObjectId("id"),
  asyncHandler(campaignController.start),
);
route.post(
  "/campaigns/:id/pause",
  validateObjectId("id"),
...
route.post(
  "/campaigns/:id/resume",
  validateObjectId("id"),
  asyncHandler(campaignController.resume),
);
route.post(
  "/campaigns/:id/cancel",
  validateObjectId("id"),
...
route.post(
  ...
  validateObjectId("id"),
  asyncHandler(campaignController.unschedule),
);
...
route.get(
  "/messages/:id",
  validateObjectId("id"),
  asyncHandler(messageController.getOne),
);
route.post(
  "/messages/:id/cancel",
  validateObjectId("id"),
  asyncHandler(messageController.cancel),
);
